...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form method = "get"action = "{{ route('search.categories') }}"
                        ...
                        <div class="input-group">
                            <input type="text"name="search" class="form-control bg-light border-0 small" placeholder="Search for Categories"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                                ...
                                <form method = "get"action="{{ route('search.categories') }}" class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <table class = "table text-center">
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $data->name }}</td>
                                    <td>
                                        <button class = "btn btn-link"><a href="{{ route('categories.edit',$data->id) }}">Edit</a></button>
                                        <form id = "delete-form-{{ $data->id }}" action="{{ route('categories.destroy',$data->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
    ...
    <!-- Bootstrap core JavaScript-->
     <script src=<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.15.2/sweetalert2.min.js" integrity="sha512-gtx8/kJpAsm7drqGdR5bl6CQtb+zzNY2wfWdzAe7wt0vCgFph7fX2ubCyxZn9CEGE/I9xasdwkaVPaKQGlq1Lw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>></script>
...
<script>
    function downloadAndRedirect() {
        // Trigger download
        const downloadUrl = "{{ route('report.categories') }}";
