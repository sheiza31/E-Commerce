                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for Products"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            ...
                            <form action="{{ route('products.update',$products->id) }}" method="post"enctype="multipart/form-data">
                                ...
                                <br>
                                <textarea class = "form-control" name="description" id="" cols="30" rows="10">{{ $products->description }}</textarea>
                                <br>
                                <div class="mb-3">
                                ...
                                <br>
                                <input class = "form-control" type="number"name="stock"value="{{ $products->stock  }}"min="0">
                                <br>
